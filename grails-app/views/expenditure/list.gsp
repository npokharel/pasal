	...
	<body>
		...
		<div id="list-expenditure" class="content scaffold-list" role="main">
			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="particulars" title="${message(code: 'expenditure.particulars.label', default: 'Particulars')}" />
				...
				<g:each in="${expenditureInstanceList}" status="i" var="expenditureInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${expenditureInstance.id}">${fieldValue(bean: expenditureInstance, field: "amount")}</g:link></td>
					
						<td><g:formatDate date="${expenditureInstance.date}" /></td>
					
						<td>${fieldValue(bean: expenditureInstance, field: "particulars")}</td>
			...
			<div class="pagination">
				<g:paginate total="${expenditureInstanceTotal}" />
			</div>
		</div>
	</body>
</html>
