...
class ProductController {
    ...
    def save() {
        ...
        def json =  pasalElasticSearchService.filterParams(params)
        try {
            def response = pasalElasticSearchService.writeBillIndex('pasal', 'product', client, json)
        } catch ( Exception e) {
            flash.message = ('error')
        }

        client.close()
        flash.message = message(code: 'default.created.message'/*, args: [message(code: 'product.label', default: 'Product')]*/)
